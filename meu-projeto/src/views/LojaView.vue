<template>
  <div class="min-h-screen bg-gray-50">
      ...
      <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          ...
          <div class="flex items-center">
            <h1 class="text-xl font-bold text-gray-900">Smart Factory Store</h1>
          </div>

          <!-- Navigation -->
          <nav class="hidden space-x-8 md:flex">
            <router-link to="/loja" class="font-medium text-blue-600">Produtos</router-link>
            <router-link to="/meus-pedidos" class="text-gray-500 hover:text-gray-700">Meus Pedidos</router-link>
          </nav>
    ...
    <main class="px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <!-- Hero Section -->
      <div class="p-8 mb-8 rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600">
        <div class="text-white">
          <h2 class="mb-2 text-3xl font-bold">Sucos Naturais da Smart Factory</h2>
